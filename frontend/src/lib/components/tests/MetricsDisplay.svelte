...
<Card class={className}>
	...
	<div class="grid grid-cols-3 gap-4 border-t border-gray-200 pt-4">
		<div class="text-center">
			<div class="text-2xl font-bold text-[#CC0000]">{formatMetric(metrics.precision)}</div>
			<div class="text-sm text-gray-600">Precision</div>
		</div>
		<div class="text-center">
			<div class="text-2xl font-bold text-[#CC0000]">{formatMetric(metrics.recall)}</div>
			<div class="text-sm text-gray-600">Recall</div>
		</div>
		<div class="text-center">
			<div class="text-2xl font-bold text-[#CC0000]">{formatMetric(metrics.f1_score)}</div>
